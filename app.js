...
2. Gebruik ECHTE feiten, getallen, namen, formules uit de lesstof. Geen vage omschrijvingen.
3. Schrijf zo dat een leerling van 16 jaar het begrijpt. Korte zinnen. Gewone woorden.
4. Elk onderwerp krijgt een CONCREET voorbeeld uit het dagelijks leven dat begint met "Denk aan...".
5. Ezelsbruggetjes moeten GRAPPIG en MEMORABEL zijn — anders werken ze niet.
6. Het "onthoud" veld is de EXACTE definitie of regel die op de toets gevraagd wordt.
7. De valkuil is de specifieke fout die de meeste leerlingen maken — wees eerlijk en direct.

KWALITEITSEIS: Als iemand dit studieplan leest en opvolgt, haalt hij de toets. Geen vaagheid toegestaan.

Geef ALLEEN JSON terug. Geen tekst ervoor of erna.

JSON formaat:
{
  "samenvatting": "2-3 zinnen die de rode draad uitleggen. Wat is het grote plaatje van deze stof?",
  "leerroute": [
    {
      "stap": 1,
      "onderwerp": "Exacte naam van het onderwerp",
      "timing": "Wanneer leren bijv. Stap 1 van 6, Dag 1 ochtend, Maandag",
      "uitleg": "Leg de stof in 5-7 zinnen volledig uit met echte feiten, getallen en formules. Eindig met: Denk aan [dagelijks leven voorbeeld].",
      "onthoud": "De EXACTE definitie of regel voor op de toets. Kort, precies, volledig.",
      "ezelsbruggetje": "Een grappig geheugensteuntje met afkorting, rijm of gek beeld. Leg uit hoe het werkt.",
      "valkuil": "De specifieke fout die de meeste leerlingen maken. Concreet en eerlijk.",
      "tijd": "Geschatte studietijd bijv. 15 min"
    }
  ],
  "herhalingsschema": [
    {"moment": "Direct na het leren", "actie": "Sluit je aantekeningen en zeg de 3 hoofdpunten op. Check daarna of je het goed had."}
  ],
  "focuspunten": [
    "Focuspunt 1 — specifiek type vraag dat gesteld wordt inclusief voorbeeldantwoord",
    "Focuspunt 2",
    "Focuspunt 3"
  ],
  "geheimtip": "Een concrete tip die alleen een docent weet over hoe de toets beoordeeld wordt of welke fouten direct punten kosten."
}`
        },
        {
          role: 'user',
          content: `Maak een persoonlijk studieplan voor het vak: ${vakNaam}.

TIJDSLOT: ${selectedTime}
INSTRUCTIE: ${cfg.planBeschrijving}
AANTAL STAPPEN IN LEERROUTE: Maak precies ${cfg.planStappen} stappen. Elke stap = 1 onderwerp volledig uitgelegd.
HERHALINGSSCHEMA: Gebruik exact deze momenten: ${cfg.herhalingsSchema.join(' → ')}
